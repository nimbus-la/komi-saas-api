...
export abstract class UserRepository {
  ...
  abstract update( tenantId: UserTenantId, user: UserAggregate): Promise<void>;
  abstract searchById( tenantId: UserTenantId, id: UserId): Promise<UserResponse | null>;
  abstract searchAggregateById( tenantId: UserTenantId, id: UserId): Promise<UserAggregate | null>;
